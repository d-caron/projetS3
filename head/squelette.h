 ...
 * @file squelette.h
 *
 * @brief Déclare un enssemble de types (tableaux/matrices de caractère/entiers) 
 ...
 * @def STR_LEN 100
 *
 * @brief Taille maximale d'une chaine de caractère dans le csv
 */
#define STR_LEN 100 
 ...
 * @def STR_MAT_COL 100
 *
 * @brief Nombre maximal de colonnes dans le csv
 */
 ...
 * @def STR_MAT_ROW 500
 *
 * @brief Nombre maximal de ligne dans le csv
 */
 ...
 * @struct s_tab_dyn
 *
 * @typedef s_tab_dyn t_tab_int_dyn
 *
 * @brief Pour encapsuler des tableaux dynamiques d'entiers avec la dimension
 */
 ...
 * @struct s_mat_dyn
 *
 * @typedef s_mat_dyn t_mat_int_dyn
 *
 * @brief Pour encapsuler des matrice 2D dynamiques d'entiers avec la dimension
 */
...
/**
 * @struct s_mat_char_dyn
 *
 * @typedef s_mat_char_dyn t_mat_char_star_dyn
 *
 * @brief Pour encapsuler des matrice 2D dynamiques de chaines de caractères
 *  avec le nombre de colonne et de lignes 
 */
 ...
 * @struct s_mat_char_dyn
 *
 * @typedef s_duel_mat t_duel_mat
 *
 * @brief Pour encapsuler des matrice de duels en conservant l'entête et les données
 */
 ...
 *
 * @brief Alloue l'espace nécessaire pour un tableau de "dim" entiers
 *  et initialise dim
 *
 ...
 *
 * @brief Alloue l'espace nécessaire pour une matrice de "nbRows" * "nbCol" entiers
 *
 ...
 *
 * @brief Permet d'afficher un tableau d'entier
 ...
 *
 * @brief Alloue la mémoire et initialise les valeurs d'une structure t_mat_int_dyn
 *
 ...
 *
 * @brief Alloue la mémoire et initialise les valeurs d'une structure t_tab_int_dyn
 *
 * @param stTab Pointeur vers la structure à créer
 * @param dim Dimension du tableau d'entier
 */
 ...
 *
 * @brief Alloue la mémoire et initialise les valeurs d'une structure t_mat_char_star_dyn
 *
 ...
 *
 * @brief Permet d'afficher une structure t_tab_int_dyn
 *  Ecrit dans la destination ciblé par logfp
 *
 ...
 *
 * @brief Permet d'afficher une structure t_mat_char_star_dyn
 *  Ecrit dans la destination ciblé par logfp
 *
 ...
 *
 * @brief Permet d'afficher une structure t_mat_int_dyn
 *  Ecrit dans la destination ciblé par logfp
 *
 * @param t_tab Structure à afficher
 * @param logfp Destination d'affichage
 ...
 *
 * @brief Permet d'afficher une matrice d'entier 
 *  Ecrit dans la destination ciblé par logfp
 *
 ...
 *
 * @brief Initialise un tableau d'entier avec la valeur passé en paramètre
 *
 ...
 *
 * @brief Initialise une matrice d'entier avec la valeur passé en paramètre
 *
 ...
 *
 * @brief Alloue l'espace pour une structure t_duel_mat et initialise la "dim"
 *  de la matrice
 *
 ...
 *
 * @brief Permet d'afficher une structure t_duel_mat
 *  Ecrit dans la destination ciblé par logfp
 *
